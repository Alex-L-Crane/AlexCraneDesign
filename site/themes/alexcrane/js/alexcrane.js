...
},{"gsap":6,"jquery":7}],2:[function(require,module,exports){
...
(0, _jquery2.default)(window).bind("load", function () {
    ...
    if (KBProcessVidExists) {
        var toggleKBProcessVid = function toggleKBProcessVid(event) {
            if (event.type == "enter") {
    ...
    if (KBDemoVidExists) {
        var toggleKBDemoVid = function toggleKBDemoVid(event) {
            if (event.type == "enter") {
...
},{"jquery":7,"scrollmagic":8}],5:[function(require,module,exports){
"use strict";
...
(0, _jquery2.default)(document).ready(function () {
    ...
    var containersize = (0, _jquery2.default)(".l-centered-column").width();

    function checkWidth() {
        var windowsize = $window.width();
        if (windowsize > 900) {
            var marginLeft = (windowsize - containersize) / 2;
            (0, _jquery2.default)(".KBProcessVidWrap").css({ marginLeft: marginLeft });
        } else {
            (0, _jquery2.default)(".KBProcessVidWrap").css({ marginLeft: 0 });
        }
    }
